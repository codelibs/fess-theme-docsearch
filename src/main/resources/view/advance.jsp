...
<%@ include file="gtmBody.jsp" %>
						...
						<ul class="nav navbar-nav">
							...
							<c:choose>
								<c:when test="${!empty username && username != 'guest'}">
									<li class="nav-item">
										<div class="dropdown">
											<a id="userMenu" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true"
												aria-expanded="false"
	...
	<script type="text/javascript" src="${fe:url('/js/docsearch/jquery-3.7.1.min.js')}"></script>
	...
	<script type="text/javascript" src="${fe:url('/js/docsearch/advance.js')}"></script>
</body>
</html>
